...
// in simulator we redefine to format for ArduinoReference Developer console
...
{\
	NSString * exceptionName = [@"org.arduinoreference." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.arduinoreference";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIArduinoReferenceNativeItemNone = -1, 
	UIArduinoReferenceNativeItemSpinner = -2,
	UIArduinoReferenceNativeItemProgressBar = -3,
	
	UIArduinoReferenceNativeItemSlider = -4,
	UIArduinoReferenceNativeItemSwitch = -5,
	UIArduinoReferenceNativeItemMultiButton = -6,
	UIArduinoReferenceNativeItemSegmented = -7,
	
	UIArduinoReferenceNativeItemTextView = -8,
	UIArduinoReferenceNativeItemTextField = -9,
	UIArduinoReferenceNativeItemSearchBar = -10,
	
	UIArduinoReferenceNativeItemPicker = -11,
	UIArduinoReferenceNativeItemDatePicker = -12,
	
	UIArduinoReferenceNativeItemInfoLight = -13,
	UIArduinoReferenceNativeItemInfoDark = -14,
	
	UIArduinoReferenceNativeItemDisclosure = -15,
	
	UIArduinoReferenceNativeItemContactAdd = -16
};
